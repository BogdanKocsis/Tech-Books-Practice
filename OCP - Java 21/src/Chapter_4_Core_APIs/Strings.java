...
public class Strings {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(example.length()); //return numbers of characters in the string.
        System.out.println(example.charAt(5));// return characters is a specific position.
        System.out.println(example.charAt(0) + " " + example.codePointAt(0));  // W 87
