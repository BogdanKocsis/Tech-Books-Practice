...
public class ExchangerDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        Runnable run1 = () -> {
            try {
                String message = exchanger.exchange("Message #1"); // Waits for another thread to arrive at this point
                System.out.println("Received from another thread in task #1: " + message);
        ...
        Runnable run2 = () -> {
            try {
                String message = exchanger.exchange("Message #2"); // Waits for another thread to arrive at this point
                System.out.println("Received from another thread in task #2: " + message);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        };
